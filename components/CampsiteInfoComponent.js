    ...
    return (
      <Animatable.View animation='fadeInDown' duration={2000} delay={1000}>
        <Card featuredTitle={campsite.name} image={{ uri: baseUrl + campsite.image }}>
          ...
          <Icon name={'pencil'} type='font-awesome' reverse raised color='#5673DD' onPress={() => props.onShowModal()} style={styles.cardItem}/>
          </View>
        </Card>
      </Animatable.View>
    );
        ...
        >
          <View style={styles.modal}>
            ...
            <Input
              leftIcon={
                <Icon
                  name='comment-o' type='font-awesome'
                />
              }
              leftIconContainerStyle={{paddingRight: 10}}
            ...
            />
            <View style={{margin: 10}}>
              <Button title='Submit' color='#5637DD' onPress={() => {this.handleComment(campsiteId)}} />
            </View>
            <View style={{margin: 10}}>
